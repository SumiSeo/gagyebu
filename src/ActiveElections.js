...
class ActiveElections extends Component {
  ...
  loadData = async () => {
    ...
    for (let i = 0; i < eCount; i++) {
      ...
      let election = await new this.app.web3.eth.Contract(
        ElectionJSON.abi,
        elections[i]
      );
      ...
      electionDetails[i].hasVoted = await election.methods
        .voters(this.app.account[0])
        .call();
      ...
      electionDetails[i].electionDescription = await election.methods
        .description()
        .call();
